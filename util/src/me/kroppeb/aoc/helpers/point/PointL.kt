...
data class PointL(val x: Long, val y: Long) : PointNL<PointL> {
	...
	override fun min(other: PointL): PointL = kotlin.math.min(this.x, other.x) toP kotlin.math.min(this.y, other.y)
	override fun max(other: PointL): PointL = kotlin.math.max(this.x, other.x) toP kotlin.math.max(this.y, other.y)
