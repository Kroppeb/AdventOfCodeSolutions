...
data class Point(val x: Int, val y: Int) : PointNI<Point> {
	...
	override fun min(other: Point): Point = kotlin.math.min(this.x, other.x) toP kotlin.math.min(this.y, other.y)
	override fun max(other: Point): Point = kotlin.math.max(this.x, other.x) toP kotlin.math.max(this.y, other.y)
