...
private fun part1() {
	...
	data.asQuadGraph { a, b -> h(a.v) - h(b.v) >= -1 }.bfs(data.single { it.v == 'S' }) { it.v == 'E' } log 1
}
...
private fun part2() {
	...
	data.asQuadGraph { a, b -> h(a.v) - h(b.v) >= -1 }.bfs(data.filter { h(it.v) == 'a' }) { it.v == 'E' } log 2
}
